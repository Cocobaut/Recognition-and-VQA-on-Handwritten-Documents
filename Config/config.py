...
# --- ĐÃ SỬA THÀNH ĐƯỜNG DẪN TƯƠNG ĐỐI ---
# Giờ bạn có copy code sang ổ C, D, E hay đưa lên Docker thì nó vẫn chạy ngon lành
...
Output_Json_Task_3 = "SubmissionFinalCode/Task3/predict"
